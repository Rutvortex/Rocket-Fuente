...
console.log('')
console.log('Sigue estos pasos para usar el certificado local:')
console.log('  1) Asegúrate de que VITE_DEV_HOST en Frontend/.env coincida con tu IP local.')
console.log('  2) Ejecuta "npm run https" desde la carpeta Frontend.')
console.log('  3) Si accedes desde el navegador a HTTPS con IP, acepta el certificado local generado.')
